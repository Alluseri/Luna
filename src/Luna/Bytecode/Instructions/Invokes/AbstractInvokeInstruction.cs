...
public abstract class AbstractInvokeInstruction : Instruction {
	...
	public AbstractInvokeInstruction(ReferenceTypeDescriptor ClassDescriptor, MethodDescriptor Method, bool Interface) : base(3) {
		this.Class = ClassDescriptor;
		this.Method = Method;
		this.Interface = Interface;
	}
	public AbstractInvokeInstruction(string ClassName, MethodDescriptor Method, bool Interface) : base(3) {
		this.Class = ReferenceTypeDescriptor.ParseSymbolic(ClassName);
		this.Method = Method;
		this.Interface = Interface;
	}
	public AbstractInvokeInstruction(CodeReader.ManagedMethodReference Mref) : this(Mref.ClassName, Mref.Method, Mref.Interface) { }
