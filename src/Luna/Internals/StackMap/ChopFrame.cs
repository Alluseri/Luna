...
public class ChopFrame : StackMapFrame {
	...
	public ChopFrame(ushort OffsetDelta, int ChopLocals) : base(OffsetDelta) {
	...
	public static ChopFrame? Parse(Stream Stream, byte Tag)
	=> Stream.ReadUShort(out ushort OffsetDelta) ? new ChopFrame(OffsetDelta, Tag - 247) : null;
